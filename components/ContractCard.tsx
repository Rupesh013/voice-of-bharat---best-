      ...
      <div>
        <div className="flex justify-between items-start">
          ...
          {contract.buyerVerified && (
            <span className="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full">Verified Buyer</span>
          )}
        </div>
        <p className="text-gray-500 mt-1">By: {contract.buyerName}</p>
