        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <section className="relative bg-cover bg-center text-white py-20" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1579202673431-ca364491a1a7?q=80&w=2070&auto=format&fit=crop')" }}>
                ...
                <div className="container mx-auto px-6 text-center relative z-10">
                    <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">{t('pages.contractFarming.title')}</h1>
                    <p className="text-lg md:text-xl text-gray-200 max-w-3xl mx-auto">
                        {t('pages.contractFarming.subtitle')}
                    </p>
                </div>
            </section>
            ...
            <section className="py-16">
                <div className="container mx-auto px-6">
                    ...
                    <h2 className="text-3xl font-bold text-gray-800 mb-8">{t('pages.contractFarming.myContracts')}</h2>
                    {MY_CONTRACTS.length > 0 ? (
                        ...
                        <div className="text-center bg-white p-8 rounded-lg shadow-md">
                            <p className="text-gray-600">{t('pages.contractFarming.noContracts')}</p>
                        </div>
                    )}
                </div>
            </section>
            ...
            <section className="py-16 bg-gray-100">
                <div className="container mx-auto px-6">
                    <h2 className="text-3xl font-bold text-gray-800 mb-8">{t('pages.contractFarming.availableContracts')}</h2>
